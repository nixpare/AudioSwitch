    ...
    return (
        <>
            <For each={Object.values(devices)} >{
                (device) => <Device device={device} pref={false} />
            }</For>
        </>
    )
}
...
function SelectedDevice() {
    ...
    return (
        <>
            <h3>Select device:</h3>
            <div class={`device ${appState.Muted ? 'muted' : ''}`} style={`min-width: ${size()}px`}>{selected()}</div>
...
function Device(props) {
    ...
    return (
        <li id={props.device.ID} class={`btn ${props.device.pref ? 'pref' : ''}`} device onclick={handleClick}>
            {props.device.Name}
            <PrefButton id={props.device.ID} />
        </li>
    )
}
...
function PrefButton(props) {
    ...
    return (
        <button class="btn" onclick={handleClick}>
            ...
            <svg class="pref" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512">{/*<!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->*/}
...
function HotkeyManager() {
    ...
    return (
        <>
            ...
            <button class="btn hotkey-del" onclick={deleteHotkey}>
                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <button class="btn hotkey-save" onclick={saveHotkey}>
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512">{/*<!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->*/}
                    <path
...
render(() => <Exit />, document.querySelector('[exit]'))
